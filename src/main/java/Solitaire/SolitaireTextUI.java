...
public class SolitaireTextUI {
    ...
    private void menu() {
        System.out.println("A) Mover pila de residuos a la base");
        System.out.println("B) Dibujar cartas");
        System.out.println("C) Recargar pila de robo");
        System.out.println("D) Mover Tableau a la base");
        System.out.println("E) Mover Tableau a Tableau");
        System.out.println("F) Mover pila de residuos a Tableau");
